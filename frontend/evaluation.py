...
def _render_evaluation_result(gen_model_name: str, evaluator_name: str, eval_result: Dict[str, Any]):
    ...
    if "error" in eval_result:
        ...
        st.text_area(
            f"Eval {evaluator_name} {gen_model_name}:",
            eval_result["text"],
            height=400,
            disabled=True,
...
def handle_evaluation(
    evaluation_template: str, available_models: Dict[str, Dict[str, Any]], on_change_callback: Callable
) -> None:
    ...
    selected_evaluators = st.multiselect(
        "Choose up to 2 evaluator models:",
            ...
            async def evaluate_all():
                ...
                for evaluator_name in selected_evaluators:
                    ...
                    for gen_model in gen_model_names:
                        ...
                        tasks.append(
                            generate_openrouter_response_async(evaluator_id, final_eval_prompt, params=evaluator_params)
                        )
