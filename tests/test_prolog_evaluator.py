...
class TestDangerousPatterns:
    ...
    def test_pattern_catches_dangerous_code(self, dangerous_code):
        matched = any(re.search(pattern, dangerous_code, re.IGNORECASE) for pattern in DANGEROUS_PATTERNS)
    ...
    def test_pattern_allows_safe_code(self, safe_code):
        matched = any(re.search(pattern, safe_code, re.IGNORECASE) for pattern in DANGEROUS_PATTERNS)
